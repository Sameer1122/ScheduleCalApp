...
import MeetingTypePage from "@components/booking/pages/MeetingTypePage";
import UnAuthLayout from "@components/layout/unauth";

import { ssrInit } from "@server/lib/ssr";

export type MeetingTypePageProps = inferSSRProps<typeof getServerSideProps>;

export default function Type(props: MeetingTypePageProps) {
  const { t } = useLocale();
