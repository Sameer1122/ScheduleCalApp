...
import { Steps, Button, message, Input, Image, Typography, Space } from "antd";
  ...
  return (
    (isReady && (
      <UnAuthLayout>
        ...
        <div className="flex items-end justify-center p-[40px] m-[30px] bg-white" style={{
          boxShadow: "0px 4px 8px -2px rgb(16 24 40 / 10%), 0px 2px 4px -2px rgb(16 24 40 / 6%)"
        }}>
          <Space direction="vertical">
            ...
            >
              <Image src={`${process.env.NEXT_PUBLIC_WEBSITE_URL}/custom/done.png`} />
              <TopText style={{ color: "#005C3E" }}>
                This meeting is scheduled
              </TopText>

              <DescriptionText>
                The meeting details will be emailed to you shortly. Check your spam
                folder in case you don’t receive the invite. If you have any questions
                before our meeting, please call me directly: (309) 663-5963.
              </DescriptionText>
            </Space>
            <TopText>{eventName}</TopText>
            <DescriptionText>{props.eventType.description}</DescriptionText>
            <TopText> Meeting details</TopText>
            <Space>
              <ClockCircleOutlined style={{ color: "#007A3E" }} />
              <DescriptionText>{props.eventType.length} mins </DescriptionText>
            </Space>

            <Space>
              <VideoCameraOutlined style={{ color: "#007A3E" }} />
              <DescriptionText>
                {location && (
                  <>
            ...
            <Space>
              <CalendarOutlined style={{ color: "#007A3E" }} />
              <DescriptionText>{date.format("ddd, DD MMMM YYYY")} {date.format(is24h ? "H:mm" : "h:mma")}</DescriptionText>
            </Space>
            {!needsConfirmation && (
